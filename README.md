...
- GLIBC >=2.34
`sudo echo "deb http://cz.archive.ubuntu.com/ubuntu noble main" >> /etc/apt/sources.list && sudo apt update && sudo apt install libc6-dev -y`
- Cuda 12+ drivers (525+)
...
- CPU+GPU mining use COMING SOON
- Only GPU mining use  COMING SOON
